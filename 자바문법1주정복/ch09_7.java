...
public class ch09_7 extends JFrame {
	...
	private JButton btn [] = new JButton [text.length]; // 버튼 갯수도 배열로 선언
	...
	public ch09_7() {
		...
		JPanel q = new JPanel(); // 패널의 사용법을 유심히 봐야한다.
		c.add(q, BorderLayout.SOUTH); //남쪽에 패널을 달고 그 패널에 버튼을 3개를 넣는다는 아이디어.
		// 3 개의 버튼 생성
	...
	class MyActionListener implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			ch09_7.this.setTitle("0으로 만들기"); // 타이틀 바 초기화
